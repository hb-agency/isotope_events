 ...
 * @package    Controller
 */
class ModuleEventLister extends ModuleEventCalendars
{
	 ...
	 * @var string
	 */
	protected $strTemplate = 'mod_eventlister';
	...
	public function generate()
	{
		if (TL_MODE == 'BE')
		{
			...
			$objTemplate->wildcard = '### ISO EVENT LISTER ###';
	...
	protected function compile()
	{
		...
		// Get all events
		$arrAllEvents = $this->getAllEvents($this->iso_arrEventIDs, $this->cal_calendar, $strBegin, $strEnd);
